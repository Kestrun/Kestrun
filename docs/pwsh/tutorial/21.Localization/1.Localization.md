...
6. Route: `Add-KrMapRoute` exposes `/cultures` using `Get-KrLocalizationCultures`.
...
- [Get-KrLocalizationCultures][Get-KrLocalizationCultures]
...
[Get-KrLocalizationCultures]: /pwsh/cmdlets/Get-KrLocalizationCultures
