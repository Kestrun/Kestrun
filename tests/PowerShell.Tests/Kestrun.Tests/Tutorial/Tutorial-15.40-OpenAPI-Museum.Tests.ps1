...
Describe 'OpenAPI Museum Example' -Tag 'OpenApi', 'Slow' {
    BeforeAll {
        ...
        $script:instance = Start-ExampleScript -Name '15.40-Museum.ps1'
    ...
    It 'OpenAPI JSON equals expected museum-api.json' {
        ...
        $expectedPath = Join-Path $script:repoRoot 'docs\\_includes\\examples\\pwsh\\Assets\\OpenAPI\\museum-api.json'
