<#
    ...
    .EXAMPLE
        $formattedMessage = Get-KrFormattedMessage -Logger $logger -Level 'Error' -Message 'An error occurred: {ErrorMessage}' -PropertyValues @{'ErrorMessage' = $errorMessage} -Exception $exception
