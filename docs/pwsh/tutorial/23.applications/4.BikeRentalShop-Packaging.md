...
- `examples/PowerShell/BikeRentalShop/Synchronized/Service.psd1`
- `examples/PowerShell/BikeRentalShop/Concurrent/Service.psd1`
- `examples/PowerShell/BikeRentalShop/Web/Service.psd1`
...
2. Source folders: Package `Synchronized/`, `Concurrent/`, and `Web/` directly from `examples/PowerShell/BikeRentalShop`.
...
6. Application data: Each BikeRentalShop descriptor declares `ApplicationDataFolders = 'data/', 'logs/'`, which keeps state and logs preserved during service updates.
