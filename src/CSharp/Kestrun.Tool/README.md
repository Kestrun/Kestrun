...
- `service update --package` respects descriptor `PreservePaths` (relative file/folder paths) and restores those paths from the current install after package content is applied.
