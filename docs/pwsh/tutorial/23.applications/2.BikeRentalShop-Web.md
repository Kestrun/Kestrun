...
- `examples/PowerShell/BikeRentalShop/Web/README.md`
- `examples/PowerShell/BikeRentalShop/Web/Service.ps1`
- `examples/PowerShell/BikeRentalShop/Web/Pages/Index.cshtml`
- `examples/PowerShell/BikeRentalShop/Web/Pages/Operations.cshtml`
- `examples/PowerShell/BikeRentalShop/Web/wwwroot/app.js`
...
1. Entry point: Start `examples/PowerShell/BikeRentalShop/Web/Service.ps1` directly from the repository checkout.
