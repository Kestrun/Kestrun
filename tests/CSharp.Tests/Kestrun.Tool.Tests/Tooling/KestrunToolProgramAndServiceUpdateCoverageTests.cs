...
public class KestrunToolProgramAndServiceUpdateCoverageTests
{
    ...
    private static object CreateParsedCommand(
        ...
        string? serviceRuntimeSource = null,
        string? serviceRuntimePackage = null,
        string? serviceRuntimeVersion = null,
        string? serviceRuntimePackageId = null,
        string? serviceRuntimeCache = null,
        ...
        bool rawOutput = false)
    {
        ...
        var parsed = Activator.CreateInstance(
            ...
            [
                ...
                serviceRuntimePackage,
                serviceRuntimeVersion,
                serviceRuntimePackageId,
                serviceRuntimeCache,
