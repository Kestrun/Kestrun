...
.DESCRIPTION
    The Join-KeyUsageFlag function takes an array of X509KeyUsageFlags and combines them using a bitwise OR operation to produce a single X509KeyUsageFlags value
...
.EXAMPLE
    $combinedFlags = Join-KeyUsageFlag -KeyUsage DigitalSignature, KeyEncipherment
