...
File: [`pwsh/tutorial/examples/15.4-OpenAPI-Component-Parameter.ps1`][15.4-OpenAPI-Component-Parameter.ps1]

```powershell
{% include examples/pwsh/15.4-OpenAPI-Component-Parameter.ps1 %}
```
...
[15.4-OpenAPI-Component-Parameter.ps1]: {{ site.baseurl }}/docs/_includes/examples/pwsh/15.4-OpenAPI-Component-Parameter.ps1
