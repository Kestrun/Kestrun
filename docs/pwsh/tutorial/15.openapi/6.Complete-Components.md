...
File: [`pwsh/tutorial/examples/15.6-OpenAPI-RequestBody-Response-Component.ps1`][15.6-OpenAPI-RequestBody-Response-Component.ps1]

```powershell
{% include examples/pwsh/15.6-OpenAPI-RequestBody-Response-Component.ps1 %}
```
...
[15.6-OpenAPI-RequestBody-Response-Component.ps1]: {{ site.baseurl }}/docs/_includes/examples/pwsh/15.6-OpenAPI-RequestBody-Response-Component.ps1
