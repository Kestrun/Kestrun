...
File: [`pwsh/tutorial/examples/15.14-PetStore.ps1`][15.14-PetStore.ps1]

```powershell
{% include examples/pwsh/15.14-PetStore.ps1 %}
```
...
[15.14-PetStore.ps1]: https://github.com/Kestrun/Kestrun/blob/main/docs/_includes/examples/pwsh/15.14-PetStore.ps1
