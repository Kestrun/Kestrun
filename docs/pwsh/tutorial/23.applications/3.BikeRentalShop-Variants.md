...
- `examples/PowerShell/BikeRentalShop/Concurrent/Private/State.ps1`
...
1. Entry point: Start either `examples/PowerShell/BikeRentalShop/Synchronized/Service.ps1` or `examples/PowerShell/BikeRentalShop/Concurrent/Service.ps1` directly.
