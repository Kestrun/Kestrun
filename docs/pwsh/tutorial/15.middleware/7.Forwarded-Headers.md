...
- Kestrun currently applies forwarded headers after routing, CORS, and exception handling,
  so routes see the corrected values even though the middleware does not run at the
