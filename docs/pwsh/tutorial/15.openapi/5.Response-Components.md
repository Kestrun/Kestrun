...
File: [`pwsh/tutorial/examples/15.5-OpenAPI-Component-Response.ps1`][15.5-OpenAPI-Component-Response.ps1]

```powershell
{% include examples/pwsh/15.5-OpenAPI-Component-Response.ps1 %}
```
...
[15.5-OpenAPI-Component-Response.ps1]: {{ site.baseurl }}/docs/_includes/examples/pwsh/15.5-OpenAPI-Component-Response.ps1
