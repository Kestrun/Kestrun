...
public partial class OpenApiDocDescriptor
{
    ...
    /// </summary>
    public const string DefaultAutoErrorResponseSchemaId = "KestrunErrorResponse";

    /// <summary>
    /// Default content type used for autogenerated OpenAPI client-error responses.
    /// </summary>
    public const string DefaultAutoErrorResponseContentType = "application/problem+json";
    /// <summary>
    ...
    /// </summary>
    public string AutoErrorResponseSchemaId { get; set; } = DefaultAutoErrorResponseSchemaId;

    /// <summary>
    /// Gets or sets the content types used for autogenerated OpenAPI client-error responses.
    /// </summary>
    public string[] AutoErrorResponseContentTypes { get; set; } = [DefaultAutoErrorResponseContentType];
