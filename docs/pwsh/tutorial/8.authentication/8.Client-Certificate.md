...
**Note:** Use `Import-KrCertificate` instead of `Import-PfxCertificate` for cross-platform compatibility. The Kestrun cmdlet doesn't require a Windows certificate store and works on both Windows and Linux.
