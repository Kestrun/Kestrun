...
File: [`pwsh/tutorial/examples/15.3-OpenAPI-Component-RequestBody.ps1`][15.3-OpenAPI-Component-RequestBody.ps1]

```powershell
{% include examples/pwsh/15.3-OpenAPI-Component-RequestBody.ps1 %}
```
...
[15.3-OpenAPI-Component-RequestBody.ps1]: {{ site.baseurl }}/docs/_includes/examples/pwsh/15.3-OpenAPI-Component-RequestBody.ps1
