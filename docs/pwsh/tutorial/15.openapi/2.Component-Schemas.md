...
File: [`pwsh/tutorial/examples/15.2-OpenAPI-Component-Schema.ps1`][15.2-OpenAPI-Component-Schema.ps1]

```powershell
{% include examples/pwsh/15.2-OpenAPI-Component-Schema.ps1 %}
```
...
6. POST endpoint: Accept CreateUserRequest body and return UserResponse.
7. GET endpoint: Return UserResponse for a given user ID.
...
[15.2-OpenAPI-Component-Schema.ps1]: {{ site.baseurl }}/docs/_includes/examples/pwsh/15.2-OpenAPI-Component-Schema.ps1
