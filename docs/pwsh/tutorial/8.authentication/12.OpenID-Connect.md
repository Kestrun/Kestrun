...
6. Routes: Add a public landing and protected routes using `-AuthorizationSchema 'oidc'` (policy scheme forwards challenge to OIDC and authenticates via cookie).
