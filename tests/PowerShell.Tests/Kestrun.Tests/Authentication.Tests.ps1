...
Describe 'Kestrun Authentication' {
    ...
    Describe 'Basic Authentication' {
        ...
        It 'ps/hello in C#' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cs/hello" -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'ps/policy (CanRead)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/ps/policy" -Method GET -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'ps/policy (CanDelete)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/ps/policy" -Method DELETE `
        ...
        It 'ps/policy (CanCreate)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/ps/policy" -Method POST -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'ps/policy (CanUpdate)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/ps/policy" -Method PUT -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'ps/policy (CanPatch)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/ps/policy" -Method PATCH `
                    -SkipCertificateCheck -Headers @{Authorization = $script:basic } -ErrorAction SilentlyContinue } |
        ...
        It 'vb/hello in VB.Net' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/hello" -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'vb/policy (CanRead)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/policy" -Method GET `
                    -SkipCertificateCheck -Headers @{Authorization = $script:basic } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*403*'
        }

        It 'vb/policy (CanDelete)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/policy" -Method DELETE `
                    -SkipCertificateCheck -Headers @{Authorization = $script:basic } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*403*'
        }

        It 'vb/policy (CanCreate)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/policy" -Method POST -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'vb/policy (CanUpdate)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/policy" -Method PUT -SkipCertificateCheck -Headers @{Authorization = $script:basic }
            $result.StatusCode | Should -Be 200
        ...
        It 'vb/policy (CanPatch)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/vb/policy" -Method PATCH `
                    -SkipCertificateCheck -Headers @{Authorization = $script:basic } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*405*'
        }
    }
    ...
    Describe 'Key Authentication' {
        ...
        It 'key authentication Hello Simple mode' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/simple/hello" -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' }
        ...
        It 'key authentication Hello in powershell' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/hello" -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' }
        ...
        It 'key authentication Hello in CSharp' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/cs/hello" -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' }
        ...
        It 'key authentication Hello in VB.Net' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/vb/hello" -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' }
        ...
        It 'key/policy (CanRead)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/policy" -Method GET `
                    -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*403*'
        }

        It 'key/policy (CanDelete)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/policy" -Method DELETE -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' } `
                    -ErrorAction SilentlyContinue } | Should -Throw -ExpectedMessage '*403*'
        }

        It 'key/policy (CanCreate)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/policy" -Method Post -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' }
            $result.StatusCode | Should -Be 200
        ...
        It 'key/policy (CanUpdate)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/policy" -Method Put `
                    -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*403*'
        }

        It 'key/policy (CanPatch)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/key/ps/policy" -Method PATCH -SkipCertificateCheck -Headers @{ 'X-Api-Key' = 'my-secret-api-key' } -ErrorAction SilentlyContinue } |
                Should -Throw -ExpectedMessage '*405*'
        }
    }
    ...
    Describe 'JWT Authentication' {
        ...
        It 'Hello JWT' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/hello" -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token" }
            $result.StatusCode | Should -Be 200
            $result.Content | Should -Be 'Welcome, admin! You are authenticated by JWT Bearer Token.'
            $result.Headers.'Content-Type' | Should -Be 'text/plain; charset=utf-8'
        }
        It 'jwt/policy (CanRead)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/policy" -Method Get -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token" }
            $result.StatusCode | Should -Be 200
        ...
        It 'jwt/policy (CanDelete)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/policy" -Method Delete -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token" } } | Should -Throw -ExpectedMessage '*403*'
        }

        It 'jwt/policy (CanCreate)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/policy" -Method Post -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token" } } | Should -Throw -ExpectedMessage '*403*'
        }

        It 'jwt/policy (CanUpdate)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/policy" -Method Put -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token" } } | Should -Throw -ExpectedMessage '*403*'
        }

        It 'jwt/policy (CanPatch)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/policy" -Method PATCH `
        ...
        It 'Renew Token' {
            ...
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/jwt/hello" -SkipCertificateCheck -Headers @{ Authorization = "Bearer $token2" }
            $result.StatusCode | Should -Be 200
            $result.Content | Should -Be 'Welcome, admin! You are authenticated by JWT Bearer Token.'
            $result.Headers.'Content-Type' | Should -Be 'text/plain; charset=utf-8'
        }
    ...
    Describe 'Cookies Authentication' {
        BeforeAll {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/cookies/login" -SkipCertificateCheck -Method Post -Body @{ username = 'admin'; password = 'secret' } -SessionVariable lauthSession
        ...
        It 'Can access secure cookies endpoint' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/hello" -SkipCertificateCheck -WebSession $authSession
            $result.StatusCode | Should -Be 200
        ...
        It 'Can access secure cookies policy (GET)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/policy" -Method GET -SkipCertificateCheck -WebSession $authSession
            $result.StatusCode | Should -Be 200
        ...
        It 'Can access secure cookies policy (DELETE)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/policy" -Method DELETE -SkipCertificateCheck -WebSession $authSession -ErrorAction SilentlyContinue } | Should -Throw -ExpectedMessage '*404*'
        }
        It 'Can access secure cookies policy (POST)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/policy" -Method POST -SkipCertificateCheck -WebSession $authSession
            $result.StatusCode | Should -Be 200
        ...
        It 'Can access secure cookies policy (PUT)' {
            $result = Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/policy" -Method PUT -SkipCertificateCheck -WebSession $authSession
            $result.StatusCode | Should -Be 200
        ...
        It 'Can access secure cookies policy (PATCH)' {
            { Invoke-TestRequest -Uri "$($script:instance.Url)/secure/cookies/policy" -Method PATCH -SkipCertificateCheck -WebSession $authSession -ErrorAction SilentlyContinue } | Should -Throw -ExpectedMessage '*405*'
        }
    }
}
