...
internal static partial class Program
{
    ...
    private static bool TryParseRunArguments(string[] args, int startIndex, string? kestrunFolder, string? kestrunManifestPath, out ParsedCommand parsedCommand, out string error)
    {
        ...
        parsedCommand = new ParsedCommand(CommandMode.Run, state.ScriptPath, state.ScriptArguments, state.KestrunFolder, state.KestrunManifestPath, null, null, null, null, null, ModuleStorageScope.Local, false, null, null);
