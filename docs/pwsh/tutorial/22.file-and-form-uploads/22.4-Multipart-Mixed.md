...
4. Route: Add `/mixed` with `Add-KrFormRoute`.
5. Response: Return ordered content types and count.
...
- 415 / Unsupported Content-Type: Ensure the request `Content-Type` is `multipart/mixed; boundary=...`.
