...
File: [`pwsh/tutorial/examples/10.8-Cors-Multipolicy.ps1`][10.8-Cors-Multipolicy.ps1]

```powershell
{% include examples/pwsh/10.8-Cors-Multipolicy.ps1 %}
```
...
```powershell
.\10.8-Cors-Multipolicy.ps1 -Port 5000
```
...
[10.8-Cors-Multipolicy.ps1]: https://github.com/Kestrun/Kestrun/blob/main/docs/_includes/examples/pwsh/10.8-Cors-Multipolicy.ps1
