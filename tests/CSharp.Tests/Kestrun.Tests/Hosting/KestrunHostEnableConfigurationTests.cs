...
public class KestrunHostEnableConfigurationTests
{
    ...
    public void InitializeRunspacePool_WithValidParams_CreatesRunspacePool()
    {
        ...
        // Act
        var classesPath = Kestrun.Runtime.PowerShellOpenApiClassExporter.ExportOpenApiClasses(Serilog.Log.Logger);
    ...
    public void InitializeRunspacePool_WithNullParams_CreatesRunspacePool()
    {
        ...
        // Act
        var classesPath2 = Kestrun.Runtime.PowerShellOpenApiClassExporter.ExportOpenApiClasses(Serilog.Log.Logger);
    ...
    public void LogConfiguredEndpoints_BuildsAppAndLogsEndpoints()
    {
        // Arrange
        using var host = CreateTestHost();
        var classesPath3 = Kestrun.Runtime.PowerShellOpenApiClassExporter.ExportOpenApiClasses(Serilog.Log.Logger);
