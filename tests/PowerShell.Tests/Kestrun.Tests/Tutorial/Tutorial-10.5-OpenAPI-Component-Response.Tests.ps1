param()
Describe 'Example 10.5 OpenAPI Component Response' -Tag 'Tutorial', 'Slow' {
    BeforeAll { . (Join-Path $PSScriptRoot '..\PesterHelpers.ps1'); $script:instance = Start-ExampleScript -Name '10.5-OpenAPI-Component-Response.ps1' }
