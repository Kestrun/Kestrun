...
6. Routes: Public landing + protected routes using `-AuthorizationSchema 'GitHub'` (policy scheme forwards challenge to GitHub and authenticates via cookie).
...
- Three schemes: `GitHub`, `GitHub.Cookies`, `GitHub.Policy` (use `-AuthorizationSchema 'GitHub'` on protected routes).
