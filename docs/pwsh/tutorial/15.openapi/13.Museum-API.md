...
File: [`pwsh/tutorial/examples/15.13-Museum.ps1`][15.13-Museum.ps1]

```powershell
{% include examples/pwsh/15.13-Museum.ps1 %}
```
...
[15.13-Museum.ps1]: https://github.com/Kestrun/Kestrun/blob/main/docs/_includes/examples/pwsh/15.13-Museum.ps1
