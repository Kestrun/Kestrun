...
Describe 'Example 10.5 OpenAPI Component Response' -Tag 'OpenApi', 'Tutorial', 'Slow' {
    ...
    It 'Get Article (GET Success)' {
        $result = Invoke-TestRequest -Uri "$($script:instance.Url)/articles/1" -SkipCertificateCheck -SkipHttpErrorCheck
    ...
    It 'Get Article (GET NotFound)' {
        $result = Invoke-TestRequest -Uri "$($script:instance.Url)/articles/-2" -SkipCertificateCheck -SkipHttpErrorCheck
    ...
    It 'Create Article (POST)' {
        ...
        $result = Invoke-TestRequest -Uri "$($script:instance.Url)/articles" -Method Post -Body $body -ContentType 'application/json' -SkipCertificateCheck -SkipHttpErrorCheck
