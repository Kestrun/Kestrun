...
Describe 'Example 2.1-Multiple-Content-Types' -Tag 'Tutorial' {
    ...
    It 'Expected Text response from /hello' {
        $resp = Invoke-TestRequest -Uri "$($script:instance.Url)/hello" -UseBasicParsing -TimeoutSec 5 -Method Get
    ...
    It 'Expected Json response from /hello-json' {
        $resp = Invoke-TestRequest -Uri "$($script:instance.Url)/hello-json" -UseBasicParsing -TimeoutSec 5 -Method Get
        $resp.StatusCode | Should -Be 200
    ...
    It 'Expected Xml response from /hello-xml' {
        $resp = Invoke-TestRequest -Uri "$($script:instance.Url)/hello-xml" -UseBasicParsing -TimeoutSec 5 -Method Get
        $resp.StatusCode | Should -Be 200
    ...
    It 'Expected Yaml response from /hello-yaml' {
        $resp = Invoke-TestRequest -Uri "$($script:instance.Url)/hello-yaml" -UseBasicParsing -TimeoutSec 5 -Method Get
        $resp.StatusCode | Should -Be 200
